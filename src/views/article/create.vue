...
export default {
  ...
  methods: {
    ...
    handleUploadSuccess(file) {
      this.ruleForm.image_url = `http://rvxbmajw4.hb-bkt.clouddn.com/${file.key}?token=${this.token}`
    ...
    $imgAdd(pos, $file) {
      ...
      this.$axios({
        ...
        const image_url = `http://rvxbmajw4.hb-bkt.clouddn.com/${res.data.key}?token=${this.token}`
